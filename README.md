...
1. Health points: Represents the life of the champion. As long as the value of this attribute
...
from the fight.
1. Mana: a resource that a champion uses to use his abilities. Each time a player uses an
ability, a certain amount of mana will be consumed. Once run out, the champion cannot
use any of his abilities.
1. Normal attack damage: The amount of damage that the champion will inflict upon
the attacked champion while using a normal attack. This amount will be deducted from
the attacked champion’s health points.
1. Normal attack range: The maximum number of cells that the attacker’s normal attack
...
1. Speed: Determines how fast the champion is. The faster the champion, the sooner he
can carry out his actions before other champions.
1. Condition: Represents the current ability/inability of the champion to act. The cham-
...
1.Actions per turn: A number representing how many actions a player can do with the
